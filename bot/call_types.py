...
class CallTypes():
    ...
    Join = CallTypeMeta('Join')
    Leave = CallTypeMeta('Leave')
    StartGame = CallTypeMeta('StartGame')
    Truth = CallTypeMeta('Truth', 'user_id__int')
    Dare = CallTypeMeta('Dare', 'user_id__int')
    DoneContinue = CallTypeMeta('DoneContinue', 'chat_id__int', 'user_id__int')
